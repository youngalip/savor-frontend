          ...
          <div className="card p-4 mb-6 border border-cream-200 bg-cream-50 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm text-blue-600 font-medium">{getTimeElapsed(order.orderTime)}</p>
          ...
          {allItemsDone && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-green-800">Semua minuman telah selesai dibuat dan siap disajikan.</p>
              </div>
            </div>
          )}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.notes && (
                        <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded text-sm">
                          <span className="font-medium text-blue-900">📝 Catatan:</span>
                          <span className="text-blue-800 ml-1">{item.notes}</span>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        <div className="bg-white border-b border-cream-200 px-8 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-lg">
              <span className="text-2xl font-bold text-blue-600">{getTotalPendingItems()}</span>
              <span className="text-sm text-blue-600 font-medium">Item Pending</span>
            </div>
            <button
              onClick={() => refetch()}
              disabled={isFetching}
