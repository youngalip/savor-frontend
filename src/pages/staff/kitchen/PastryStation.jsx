...
// ✅ SOLUSI UX: Menggunakan local state agar animasi jalan duluan
          ...
          <div className="card p-4 mb-6 border border-cream-200 bg-cream-50 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm text-pink-600 font-medium">{getTimeElapsed(order.orderTime)}</p>
          ...
          {allItemsDone && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-green-800">Semua kue dan dessert telah selesai dibuat dan siap disajikan.</p>
              </div>
            </div>
          )}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.notes && (
                        <div className="mt-2 p-2 bg-pink-50 border border-pink-200 rounded text-sm">
                          <span className="font-medium text-pink-900">📝 Catatan:</span>
                          <span className="text-pink-800 ml-1">{item.notes}</span>
                        </div>
                      )}
                    </div>
                  </div>
  ...
  const updateStatusMutation = useMutation({
    ...
    onMutate: async ({ itemId, status }) => {
      ...
      queryClient.setQueryData(['station-orders', stationType], (old) => {
        ...
        // ✅ JANGAN FILTER DISINI agar modal tidak error
        return {
          ...old,
          data: {
            ...old.data,
      ...
      <div className={`flex-1 transition-all duration-300 ${isCollapsed ? 'ml-16' : 'ml-64'}`}>
        ...
        <div className="bg-white border-b border-cream-200 px-8 py-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-500 mt-1">Pesanan kue dan dessert yang sedang diproses</p>
          </div>
        ...
        <div className="p-8">
          {filteredOrders.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Saat ini tidak ada pesanan kue/dessert yang perlu diproses</p>
            </div>
          ) : (
